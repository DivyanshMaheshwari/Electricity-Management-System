...
//         1ST CLM
        ...
        JMenuItem m3 = new JMenuItem("Tax");
        master.setForeground(Color.BLUE);
        /* ---- Customer Details ---- */

        m1.setFont(new Font("monospaced", Font.PLAIN, 12));
        ImageIcon ic2 = new ImageIcon(ClassLoader.getSystemResource("icon/icon1.png"));
        Image i2 = ic2.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        m1.setIcon(new ImageIcon(i2));
...
//        5th colm;
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        }else if (msg.equals("Tax")) {
            new tax1().setVisible(true);
        }
        else if (msg.equals("Pay Bill")) {
            new pay_bills().setVisible(true);
